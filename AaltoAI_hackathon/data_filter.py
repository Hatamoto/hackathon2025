    ...
    for record in data:
        ...
        for description in record.get("descriptions", []):
            ...
            if filtered_text and filtered_text not in seen_texts:
                ...
                seen_texts.add(filtered_text)  # Add to set to track future duplicates
...
# Main function to process the extracted texts and remove duplicates
def main():
    # Load the configuration and model
    config = load_config()
    
    # Read the original structured innovations file
    input_file = 'structured_innovations.json'
    output_file = 'filtered_innovations.json'
